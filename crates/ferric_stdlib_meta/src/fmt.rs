...
fn sig_int_to_str() -> (Vec<Ty>, Ty) {
    (vec![Ty::Int], Ty::Str)
}
fn sig_float_to_str() -> (Vec<Ty>, Ty) {
    (vec![Ty::Float], Ty::Str)
}
fn sig_bool_to_str() -> (Vec<Ty>, Ty) {
    (vec![Ty::Bool], Ty::Str)
}
...
pub const FMT_FNS: &[FunctionMeta] = &[
    ...
    FunctionMeta {
        name: "int_to_str",
        params: &["n"],
        signature: Signature::Mono(sig_int_to_str),
        display: "fn(n: Int) -> Str",
    },
    FunctionMeta {
        name: "float_to_str",
        params: &["n"],
        signature: Signature::Mono(sig_float_to_str),
        display: "fn(n: Float) -> Str",
    },
    FunctionMeta {
        name: "bool_to_str",
        params: &["b"],
        signature: Signature::Mono(sig_bool_to_str),
        display: "fn(b: Bool) -> Str",
    },
];
