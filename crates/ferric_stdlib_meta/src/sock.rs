...
pub const SOCK_FNS: &[FunctionMeta] = &[
    FunctionMeta {
        name: "sock_tcp_connect",
        params: &["host", "port"],
        signature: Signature::Unknown,
        display: "fn(...)",
    },
    FunctionMeta {
        name: "sock_tcp_connect_timeout",
        params: &["host", "port", "ms"],
        signature: Signature::Unknown,
        display: "fn(...)",
    },
    ...
    FunctionMeta {
        name: "sock_tcp_listen",
        params: &["port"],
        signature: Signature::Unknown,
        display: "fn(...)",
    },
    FunctionMeta {
        name: "sock_tcp_listen_addr",
        params: &["addr", "port"],
        signature: Signature::Unknown,
        display: "fn(...)",
    },
