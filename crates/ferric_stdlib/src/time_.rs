...
pub fn register(registry: &mut NativeRegistry, interner: &mut Interner) {
    let bodies: &[(&str, crate::NativeFn)] = &[
        ...
        ("time_from_unix", builtin_time_from_unix),
        ("time_from_unix_ms", builtin_time_from_unix_ms),
        ("time_from_unix_ns", builtin_time_from_unix_ns),
        ("time_unix", builtin_time_unix),
        ("time_unix_ms", builtin_time_unix_ms),
        ("time_year", builtin_time_year),
        ("time_month", builtin_time_month),
        ("time_day", builtin_time_day),
        ("time_hour", builtin_time_hour),
        ("time_minute", builtin_time_minute),
        ("time_second", builtin_time_second),
        ("time_weekday", builtin_time_weekday),
        ("time_add_secs", builtin_time_add_secs),
        ("time_add_ms", builtin_time_add_ms),
        ("time_add_days", builtin_time_add_days),
        ("time_diff_secs", builtin_time_diff_secs),
        ("time_diff_ms", builtin_time_diff_ms),
        ("time_format", builtin_time_format),
        ("time_format_iso", builtin_time_format_iso),
        ("time_format_rfc2822", builtin_time_format_rfc2822),
        ("time_parse", builtin_time_parse),
        ("time_parse_iso", builtin_time_parse_iso),
        ("time_secs", builtin_time_secs),
        ("time_ms", builtin_time_ms),
        ("time_minutes", builtin_time_minutes),
        ("time_hours", builtin_time_hours),
        ("time_days", builtin_time_days),
        ("time_sleep", builtin_time_sleep),
    ];
    crate::register_module(
        registry,
        interner,
        ferric_stdlib_meta::time_::TIME_FNS,
        bodies,
    );
}
