...
pub fn register(registry: &mut NativeRegistry, interner: &mut Interner) {
    let bodies: &[(&str, crate::NativeFn)] = &[
        ("math_abs", builtin_math_abs),
        ("math_min", builtin_math_min),
        ("math_max", builtin_math_max),
        ("math_clamp", builtin_math_clamp),
        ("math_pow", builtin_math_pow),
        ("math_gcd", builtin_math_gcd),
        ("math_lcm", builtin_math_lcm),
        ("math_div_floor", builtin_math_div_floor),
        ("math_div_ceil", builtin_math_div_ceil),
        ("math_rem_euclean", builtin_math_rem_euclean),
        ("math_abs_f", builtin_math_abs_f),
        ("math_min_f", builtin_math_min_f),
        ("math_max_f", builtin_math_max_f),
        ("math_clamp_f", builtin_math_clamp_f),
        ("math_floor", builtin_math_floor),
        ("math_ceil", builtin_math_ceil),
        ("math_round", builtin_math_round),
        ("math_trunc", builtin_math_trunc),
        ("math_fract", builtin_math_fract),
        ("math_sqrt", builtin_math_sqrt),
        ("math_cbrt", builtin_math_cbrt),
        ("math_pow_f", builtin_math_pow_f),
        ("math_log", builtin_math_log),
        ("math_ln", builtin_math_ln),
        ...
        ("math_is_nan", builtin_math_is_nan),
        ("math_is_finite", builtin_math_is_finite),
        ("math_is_inf", builtin_math_is_inf),
        ("math_PI", builtin_math_pi),
        ("math_E", builtin_math_e),
        ("math_TAU", builtin_math_tau),
        ("math_INF", builtin_math_inf),
        ("math_NAN", builtin_math_nan),
        ("math_int_to_float", builtin_math_int_to_float),
        ("math_float_to_int", builtin_math_float_to_int),
        ("abs", builtin_math_abs),
        ("min", builtin_math_min),
        ("max", builtin_math_max),
        ("int_to_float", builtin_math_int_to_float),
        ("sqrt", crate::builtin_sqrt),
        ("pow", crate::builtin_pow),
        ("floor", crate::builtin_floor),
        ("ceil", crate::builtin_ceil),
    ];
    crate::register_module(
        registry,
        interner,
        ferric_stdlib_meta::math::MATH_FNS,
        bodies,
    );
}
