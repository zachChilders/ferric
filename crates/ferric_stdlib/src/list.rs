...
pub fn register(registry: &mut NativeRegistry, interner: &mut Interner) {
    let bodies: &[(&str, crate::NativeFn)] = &[
        ...
        ("list_of", builtin_list_of),
        ("list_repeat", builtin_list_repeat),
        ("list_range", builtin_list_range),
        ("list_range_inclusive", builtin_list_range_inclusive),
        ("list_len", builtin_list_len),
        ("list_is_empty", builtin_list_is_empty),
        ("list_get", builtin_list_get),
        ("list_first", builtin_list_first),
        ("list_last", builtin_list_last),
        ("list_slice", builtin_list_slice),
        ("list_contains", builtin_list_contains),
        ("list_find", builtin_list_find),
        ("list_find_index", builtin_list_find_index),
        ("list_index_of", builtin_list_index_of),
        ("list_map", builtin_list_map),
        ("list_flat_map", builtin_list_flat_map),
        ("list_filter", builtin_list_filter),
        ("list_filter_map", builtin_list_filter_map),
        ("list_reduce", builtin_list_reduce),
        ("list_fold", builtin_list_fold),
        ("list_scan", builtin_list_scan),
        ("list_zip", builtin_list_zip),
        ("list_zip_with", builtin_list_zip_with),
        ("list_enumerate", builtin_list_enumerate),
        ("list_flatten", builtin_list_flatten),
        ("list_chunk", builtin_list_chunk),
        ("list_window", builtin_list_window),
        ("list_take", builtin_list_take),
        ("list_drop", builtin_list_drop),
        ("list_take_while", builtin_list_take_while),
        ("list_drop_while", builtin_list_drop_while),
        ("list_partition", builtin_list_partition),
        ("list_unzip", builtin_list_unzip),
        ("list_any", builtin_list_any),
        ("list_all", builtin_list_all),
        ("list_count", builtin_list_count),
        ("list_sum", builtin_list_sum),
        ("list_sum_float", builtin_list_sum_float),
        ("list_min", builtin_list_min),
        ("list_max", builtin_list_max),
        ("list_concat", builtin_list_concat),
        ("list_prepend", builtin_list_prepend),
        ...
        ("list_unique", builtin_list_unique),
        ("list_intersperse", builtin_list_intersperse),
        ("list_join_str", builtin_list_join_str),
        ("list_builder", builtin_list_builder),
        ("list_push", builtin_list_push),
        ("list_pop", builtin_list_pop),
        ("list_build", builtin_list_build),
        ("array_len", builtin_list_len),
    ];
    crate::register_module(
        registry,
        interner,
        ferric_stdlib_meta::list::LIST_FNS,
        bodies,
    );
}
