...
pub fn register(registry: &mut NativeRegistry, interner: &mut Interner) {
    let bodies: &[(&str, crate::NativeFn)] = &[
        ("proc_run", builtin_proc_run),
        ("proc_run_shell", builtin_proc_run_shell),
        ("proc_stdout", builtin_proc_stdout),
        ("proc_stderr", builtin_proc_stderr),
        ("proc_exit_code", builtin_proc_exit_code),
        ("proc_ok", builtin_proc_ok),
        ("proc_command", builtin_proc_command),
        ("proc_arg", builtin_proc_arg),
        ("proc_args", builtin_proc_args),
        ("proc_env_set", builtin_proc_env_set),
        ("proc_env_clear", builtin_proc_env_clear),
        ("proc_cwd", builtin_proc_cwd),
        ("proc_stdin_bytes", builtin_proc_stdin_bytes),
        ("proc_stdin_str", builtin_proc_stdin_str),
        ("proc_timeout", builtin_proc_timeout),
        ("proc_spawn", builtin_proc_spawn),
        ("proc_spawn_streaming", builtin_proc_spawn_streaming),
        ("proc_write_stdin", builtin_proc_write_stdin),
        ("proc_read_stdout_line", builtin_proc_read_stdout_line),
        ("proc_wait", builtin_proc_wait),
        ("proc_kill", builtin_proc_kill),
    ];
    crate::register_module(
        registry,
        interner,
        ferric_stdlib_meta::proc_::PROC_FNS,
        bodies,
    );
}
